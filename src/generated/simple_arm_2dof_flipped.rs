...
/// Forward kinematics for `assets/urdf/custom/simple_arm_2dof_flipped.urdf`: 2 joints → 3 link poses.
...
data.link_poses[0] = link_forearm;
data.link_poses[1] = link_upper_arm;
data.link_poses[2] = link_base_link;
}
...
let axis_world_1 = data.link_poses[0].rotation * Vector3::new(0.0_f64, 1.0_f64, 0.0_f64);
let mut jac_0 = SMatrix::<f64, 6, 2>::zeros();
{ let lin = axis_world_0.cross(&(data.link_poses[0].translation.vector - data.link_poses[1].translation.vector)); let ang = axis_world_0; jac_0.set_column(0, &Vector6::new(lin.x, lin.y, lin.z, ang.x, ang.y, ang.z)); }
{ let lin = axis_world_1.cross(&(data.link_poses[0].translation.vector - data.link_poses[0].translation.vector)); let ang = axis_world_1; jac_0.set_column(1, &Vector6::new(lin.x, lin.y, lin.z, ang.x, ang.y, ang.z)); }
data.link_jacobians[0] = jac_0;
